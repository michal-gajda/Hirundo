namespace Hirundo.Infrastructure.Handlers
{
    ...
    internal sealed class GetAllInputGeneralInformationRequestHandler : IRequestHandler<GetAllInputGeneralInformationRequest, InputGeneralInformationResponse>
    {
        private readonly IConfiguration configuration;
        private readonly ILogger<GetAllInputGeneralInformationRequestHandler> logger;

        public GetAllInputGeneralInformationRequestHandler(IConfiguration configuration, ILogger<GetAllInputGeneralInformationRequestHandler> logger) =>
            (this.configuration, this.logger) = (configuration, logger);

        public async Task<InputGeneralInformationResponse> Handle(GetAllInputGeneralInformationRequest request, CancellationToken cancellationToken)
        {
