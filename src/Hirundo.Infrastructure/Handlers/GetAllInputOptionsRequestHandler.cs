namespace Hirundo.Infrastructure.Handlers
{
    ...
    internal sealed class GetAllInputOptionsRequestHandler : IRequestHandler<GetAllInputOptionsRequest, InputOptionsResponse>
    {
        private readonly IConfiguration configuration;
        private readonly ILogger<GetAllInputOptionsRequestHandler> logger;

        public GetAllInputOptionsRequestHandler(IConfiguration configuration, ILogger<GetAllInputOptionsRequestHandler> logger) =>
            (this.configuration, this.logger) = (configuration, logger);

        public async Task<InputOptionsResponse> Handle(GetAllInputOptionsRequest request, CancellationToken cancellationToken)
        {
