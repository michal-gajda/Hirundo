/**[rPT_DetailedVarianceAnalysis_SubTab2_Vehicle]**/
/****Author: Magda Jankowska********/
/***** Date: 17.02.2021 ************/
CREATE TABLE [DABI001].[dbo].[rPT_DetailedVarianceAnalysis_SubTab2_Vehicle] (
...
INSERT INTO [DABI001].[dbo].[rPT_DetailedVarianceAnalysis_SubTab2_Vehicle] 
...
INSERT INTO [DABI001].[dbo].[rPT_DetailedVarianceAnalysis_SubTab2_Vehicle] 
VALUES ('Switzerland','CA','Mokka', '0: Opel', '21.0A','2020-05-10','2020-07-01',1.1,'CHF','Trimline','GA0','C','Edition',0,10000,0,0.7,0,9000,0,0.7,0,8000,0,0.5,0,15000,'2021-03-10 17:25:00','GZ6CN8',0,1,0);
INSERT INTO [DABI001].[dbo].[rPT_DetailedVarianceAnalysis_SubTab2_Vehicle] 
VALUES ('Switzerland','CA','Mokka', '0: Opel', '21.0A','2020-05-10','2020-07-01',1.1,'CHF','Engine','FA0','B','Base',0,10000,0,0.7,0,9000,0,0.7,0,8000,0,0.5,0,15000,'2021-03-10 17:25:00','GZ6CN8',0,1,0);
INSERT INTO [DABI001].[dbo].[rPT_DetailedVarianceAnalysis_SubTab2_Vehicle] 
VALUES ('Switzerland','CA','Mokka', '0: Opel', '21.0A','2020-05-10','2020-07-01',1.1,'CHF','Engine','GA0','C','Edition',0,10000,0,0.7,0,9000,0,0.7,0,8000,0,0.5,0,15000,'2021-03-10 17:25:00','GZ6CN8',0,1,0);
INSERT INTO [DABI001].[dbo].[rPT_DetailedVarianceAnalysis_SubTab2_Vehicle] 
VALUES ('Switzerland','CA','Mokka', '0: Opel', '21.0A','2020-05-10','2020-07-01',1.1,'CHF','Body style','FA0','B','Base',0,10000,0,0.7,0,9000,0,0.7,0,8000,0,0.5,0,15000,'2021-03-10 17:25:00','GZ6CN8',0,1,0);
INSERT INTO [DABI001].[dbo].[rPT_DetailedVarianceAnalysis_SubTab2_Vehicle] 
VALUES ('Switzerland','CA','Mokka', '0: Opel', '21.0A','2020-05-10','2020-07-01',1.1,'CHF','Body style','GA0','C','Edition',0,10000,0,0.7,0,9000,0,0.7,0,8000,0,0.5,0,15000,'2021-03-10 17:25:00','GZ6CN8',0,1,0);

--DROP TABLE [DABI001].[dbo].[rPT_DetailedVarianceAnalysis_SubTab2_Vehicle] 