namespace Hirundo.Infrastructure.Handlers
{
    ...
    internal sealed class GetAllDetailedVarianceAnalysisRequestHandler : IRequestHandler<GetAllDetailedVarianceAnalysisRequest, DetailedVarianceAnalysisResponse>
    {
        private readonly IConfiguration configuration;
        private readonly ILogger<GetAllDetailedVarianceAnalysisRequestHandler> logger;

        public GetAllDetailedVarianceAnalysisRequestHandler(IConfiguration configuration, ILogger<GetAllDetailedVarianceAnalysisRequestHandler> logger) =>
            (this.configuration, this.logger) = (configuration, logger);

        public async Task<DetailedVarianceAnalysisResponse> Handle(GetAllDetailedVarianceAnalysisRequest request, CancellationToken cancellationToken)
        {
