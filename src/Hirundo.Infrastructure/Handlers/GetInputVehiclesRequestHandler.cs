namespace Hirundo.Infrastructure.Handlers
{
    ...
    internal sealed class GetInputVehiclesRequestHandler : IRequestHandler<GetInputVehiclesRequest, InputVehiclesResponse>
    {
        private readonly IConfiguration configuration;
        private readonly ILogger<GetInputVehiclesRequestHandler> logger;

        public GetInputVehiclesRequestHandler(IConfiguration configuration, ILogger<GetInputVehiclesRequestHandler> logger) =>
            (this.configuration, this.logger) = (configuration, logger);

        public async Task<InputVehiclesResponse> Handle(GetInputVehiclesRequest request, CancellationToken cancellationToken)
        {
